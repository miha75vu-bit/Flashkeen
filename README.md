...
Форматирование флешки для Entware под Windows с помощью внешних программ очень ненадежная идея, нередко пользователи сталкиваются со стабильностью работы файловой системы вплоть до неработоспособности даже через длительное время, флешкин это делает правильно, сразу на роутере с помощью утилит lunux.
...
В меню самой программы (пункт 4 в главном меню), либо выполнить:
...
### 5) Нужен ли для работы интернет, много ли места занимает?
Сам Flashkeen совсем небольшой, а необходимые утилиты для работы с дисками обычно занимают немного, буквально мегабайты. Интернет нужен для установки и в моменты скачивания пакетов/инсталляторов в соответствующих пунктах.
